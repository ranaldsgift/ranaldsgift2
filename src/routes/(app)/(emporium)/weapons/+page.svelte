...
<Breadcrumb layout="emporium">Weapons</Breadcrumb>
...
<EmporiumLayout>
	...
	{#snippet leftContent()}
		<div class="careers flex flex-col gap-2 w-full max-w-[500px]">
			{#each verminData.heroes as hero}
				<a class="flex w-full h-[60px] relative z-10 career-icon-wrapper" href={`/weapons/${hero.id}`}>
					...
					<span
						...
						style="background: url('/images/careers/hero-{hero.id}-wide.png') no-repeat center right / contain;"
					>
					</span>
							...
							<div class="weapon-item relative w-full flex flex-col justify-center">
								<span class="w-full text-center stat-label h-[48px] mt-2 grid place-content-center">
									<a
										...
										class="text-[#fae031] hover:text-white z-10"
