...
async function loadCareerFromOldURL(
	...
	careerBuild = {
		career: career,
		level5Talent: career.talents.find((talent) => talent.talentNumber === talents[0]),
		level10Talent: career.talents.find((talent) => talent.talentNumber === talents[1] + 3),
		level15Talent: career.talents.find((talent) => talent.talentNumber === talents[2] + 6),
		level20Talent: career.talents.find((talent) => talent.talentNumber === talents[3] + 9),
		level25Talent: career.talents.find((talent) => talent.talentNumber === talents[4] + 12),
		level30Talent: career.talents.find((talent) => talent.talentNumber === talents[5] + 15),
