...
<div class="page-container w-full h-[calc(100vh-50px)] tablet:h-full relative mt-[45px] tablet:mt-0">
	<div class="top-bar flex items-center pl-[20px] max-w-[100vw] tablet:px-[80px] mb-[4px] relative" bind:this={menuContainer}>
	...
	<div class="page-content max-h-[calc(100vh-150px)] tablet:max-h-[calc(100vh-100px)] overflow-y-auto">
		{@render children()}
	</div>
	<div class="bottom-bar w-full h-[50px]"></div>
</div>
...
<style>
	...
	.top-bar {
		background: url(/images/dividers/divider-line.png) bottom center / auto auto repeat-x;
	}
	.bottom-bar {
