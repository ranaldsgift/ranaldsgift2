export const traitsDataMap = {
	melee: [
		...
		},
		{
			...
			description:
				"Melee critical hits reduce the cooldown of your Career Skill by 5%. This effect can only trigger every 4 seconds.",
		},
		{
			id: "6",
			name: "Swift Slaying",
	...
	ranged_ammo: [
		...
		},
		{
			...
			description:
				"Ranged critical hits reduce the cooldown of your Career Skill by 4%. This effect can only trigger every 4 seconds.",
		},
		{
			id: "6",
			name: "Scrounger",
	...
	defence_accessory: [
		{
			...
			name: "Barkskin",
			description:
				"Taking damages reduces the damage you take from subsequent sources by 40% for 2 seconds. This effect can only trigger every 2 seconds.",
		},
		{
			id: "2",
